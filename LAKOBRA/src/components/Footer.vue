  ...
  <footer class="footer">
    <div class="container">
      <div class="col">
        ...
        <p class="description">
          Ekitaldiak eta gehiago ezagutzeko zure ataria. Egin bat komunitatearekin.
        </p>
      </div>
      ...
      <nav class="col">
        ...
        <ul class="footer-links">
          <li><router-link to="/principal">Hasiera</router-link></li>
          <li v-if="!usuario">
            <button class="btn-login" @click="$emit('abrirModal')">Saio hasi</button>
          </li>
          <li><router-link to="/artistas">Artistak</router-link></li>
          <li><router-link to="/eventos">Ekitaldiak</router-link></li>
          <li><router-link to="/contacto">Kontaktua</router-link></li>
        </ul>
      </nav>
      ...
      <div class="col">
        ...
        <div class="socials">
          ...
          <a
            href="https://www.instagram.com/lakobrakolektiboa/"
            target="_blank"
            rel="noopener noreferrer"
    ...
    <div class="bottom-bar">
      <p>2026 Lakobra. Eskubide guztiak erreserbatuta.</p>
    </div>
  </footer>
</template>
