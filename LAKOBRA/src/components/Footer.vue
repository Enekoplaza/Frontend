...
<template>
  <footer class="footer">
    <div class="container">
      ...
      <nav class="col">
        ...
        <ul class="footer-links">
          <li><router-link to="/principal">{{ $t('header.inicio') }}</router-link></li>
          <li v-if="!usuario">
            <button class="btn-login" @click="$emit('abrirModal')">{{ $t('header.login') }}</button>
          </li>
          <li><router-link to="/artistas">{{ $t('header.artistas') }}</router-link></li>
          <li><router-link to="/eventos">{{ $t('header.eventos') }}</router-link></li>
          <li><router-link to="/contacto">{{ $t('header.contacto') }}</router-link></li>
        </ul>
      </nav>
      ...
      <div class="col">
        ...
        <div class="socials">
          ...
          <a href="https://x.com" target="_blank" rel="noopener noreferrer" aria-label="Visitar nuestro Twitter" class="social-icon">
            <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" fill="currentColor">
              <path d="M14.234 10.162 22.977 0h-2.072l-7.591 8.824L7.251 0H.258l9.168 13.343L.258 24H2.33l8.016-9.318L16.749 24h6.993zm-2.837 3.299-.929-1.329L3.076 1.56h3.182l5.965 8.532.929 1.329 7.754 11.09h-3.182z" />
            </svg>
          </a>
          <a href="https://www.instagram.com/lakobrakolektiboa/" target="_blank" rel="noopener noreferrer" aria-label="Visitar nuestro Instagram" class="social-icon">
            <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" fill="currentColor">
    ...
    <div class="bottom-bar">
      <p>© 2026 Lakobra. {{ $t('footer.derechos') }}</p>
    </div>
  </footer>
</template>
