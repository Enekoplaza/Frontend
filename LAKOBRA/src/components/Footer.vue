  ...
  <footer class="footer">
    <div class="container">
      ...
      <div class="col">
        ...
        <p class="description">
          Tu portal para descubrir eventos y mucho más.
      ...
      <nav class="col">
        ...
        <ul class="footer-links">
          ...
          <li><router-link to="/socios/as">Socios/as</router-link></li>
          <li><router-link to="/artistas">Artista</router-link></li>
    ...
    <div class="bottom-bar">
      <p>© 2026 Lakobra. Todos los derechos reservados.</p>
    </div>
  </footer>
</template>
